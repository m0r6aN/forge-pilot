...
const pageMetadata: Record<PageKey, Metadata> = {
  ...
  generator: {
    ...
    description:
      'Create your complete brand identity with AI-powered creativity. Generate logos, color palettes, typography, and more.',
    openGraph: {
      title: 'Brand Generator - ForgePilot AI',
...
export const defaultMetadata: Metadata = {
  ...
  description:
    'Launch blueprint platform for business idea validation, advanced branding, and proof-backed go-to-market execution.',
